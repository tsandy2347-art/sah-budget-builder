...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground">Participant Forecast Budgets</h1>
        <p className="text-muted-foreground mt-1">
          Manage Support at Home quarterly forecast budgets for your participants.
        </p>
      </div>
